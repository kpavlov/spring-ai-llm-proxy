...
[![Kotlin CI with Maven](https://github.com/kpavlov/spring-ai-llm-proxy/actions/workflows/maven.yml/badge.svg?branch=main)](https://github.com/kpavlov/spring-ai-llm-proxy/actions/workflows/maven.yml)
